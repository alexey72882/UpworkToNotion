      ...
      {allConnected && (
        <div className="card bg-base-100 shadow max-w-xl mb-4">
          <div className="card-body">
            ...
            {syncMsg && (
              <div role="alert" className={`alert alert-outline ${syncError ? "alert-error bg-base-100" : "alert-success bg-[color-mix(in_oklch,var(--color-success)_10%,var(--color-base-100))]"}`}>
